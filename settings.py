...
DATABASES = {
    'default': {
        ...
        'NAME': 'paraphrase',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    "/home/timur/develop/web/paraphrase/static",
...
SECRET_KEY = '9d3u%34!q^co#^5(qpfu$ef&n#^d2z=&o8n=!+$q9#y)40bzr_'
